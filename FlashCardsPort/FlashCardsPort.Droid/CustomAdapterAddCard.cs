...
{
    class CustomAdapterAddCard : ArrayAdapter
    {
        private Context c;
        ...
        public CustomAdapterAddCard(Context context,int resourse, List<Card> objects):base(context, resourse, objects)
        {
            this.c = context;
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            Android.Net.Uri url = Android.Net.Uri.Parse(cards[position].Image);

...
{
	public partial class ViewAddCard_user : UIViewController
	{
		...
		public ViewAddCard_user(IntPtr handle) : base(handle)
		{
		}
		public override void ViewDidLoad()
		{
			...
			Gallery.TouchUpInside += async (sender, e) =>
		   {
			   if (CrossMedia.Current.IsPickPhotoSupported)
			   {
				   ...
				   Console.WriteLine(imagesoursce + "Imagesourse");
					Console.WriteLine(photo.Path + "Photo.Path");
